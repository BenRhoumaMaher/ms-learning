...
export default function JoinFamily({ formMethods, courses, globalError, successMessage, onSubmit }) {
    ...
    <section className="becinsjoin-container text-center">
      ...
      <FormProvider {...formMethods}>
        <div className="becinsjoin-form-container">
          <form className="becinsjoin-form" onSubmit={formMethods.handleSubmit(onSubmit)}>
            ...
            <div className="becinsjoin-input-group">
              ...
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <>
                    <input {...field} className="becinsjoin-input" placeholder="Your First Name" />
            ...
            <div className="becinsjoin-input-group">
              ...
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <>
                    <input {...field} className="becinsjoin-input" placeholder="Your Last Name" />
                    {error && <div className="error-message">{error.message}</div>}
                  </>
                )}
              />
            ...
            <div className="becinsjoin-input-group">
              ...
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <>
                    <input {...field} type="email" className="becinsjoin-input" placeholder="Your Email" />
                    {error && <div className="error-message">{error.message}</div>}
                  </>
                )}
              />
            ...
            <Controller
              ...
              render={({ field, fieldState: { error } }) => (
                <>
                  <textarea {...field} className="becinsjoin-input" rows="3" placeholder="Your Expertise" />
                  {error && <div className="error-message">{error.message}</div>}
                </>
              )}
            />
            ...
            <div className="becinsjoin-input-group">
              ...
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <>
                    <select {...field} className="becinsjoin-input">
            ...
            <Controller
              ...
              render={({ field }) => (
                <input
                  ...
                  onChange={(e) => formMethods.setValue('resume', e.target.files[0])}
                />
              )}
            />
