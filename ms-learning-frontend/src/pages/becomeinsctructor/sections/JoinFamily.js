      ...
      <div className="becinsjoin-form-container">
        <form className="becinsjoin-form">
          ...
          <div className="becinsjoin-input-group">
            ...
            <input type="text" className="becinsjoin-input" placeholder="Your Name" />
          </div>

          <label className="becinsjoin-label">Email</label>
          <input type="email" className="becinsjoin-input" placeholder="Your Email" />

          <label className="becinsjoin-label">Expertise</label>
          <textarea className="becinsjoin-input" rows="3" placeholder="Your Expertise"></textarea>

          <label className="becinsjoin-label">Choose Course</label>
          <input type="text" className="becinsjoin-input" placeholder="Preferred Course" />

          <label className="becinsjoin-label">Resume</label>
          <input type="file" className="becinsjoin-input" />

          <button type="submit" className="becinsjoin-btn">Join Our Team</button>
        </form>
      </div>
    </section>
  );
